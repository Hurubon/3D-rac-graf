...
void InitCircleRendering(int in_vertexCountPerCicle)
{
	...
	std::ifstream vShaderIfs("../shaders/Circle.vert");
	std::string vShaderCode((std::istreambuf_iterator<char>(vShaderIfs)), (std::istreambuf_iterator<char>()));
	
	std::ifstream fShaderIfs("../shaders/Circle.frag");
	std::string fShaderCode((std::istreambuf_iterator<char>(fShaderIfs)), (std::istreambuf_iterator<char>()));
